...
class TestCaseMoveForm extends Component {
    constructor(props) {
        super(props);
            ...
            <Fragment>
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        This will move the selected Test Cases.
                    </DialogContentText>
                    <Formik
                        initialValues={{
                            branch: '',
                        ...
                        onSubmit={(values, {setSubmitting}) => {
                            setSubmitting(true);
                            try {
                                this.props.onClickMove(values.branch, values.version);
                            } catch (e) {
                                console.log(e);
                                setSubmitting(false);
                            }
...
TestCaseMoveForm.propTypes = {
    classes: PropTypes.object.isRequired,
    onClickCancel: PropTypes.func.isRequired,
    onClickMove: PropTypes.func.isRequired,
};

export default withStyles(styles)(TestCaseMoveForm);